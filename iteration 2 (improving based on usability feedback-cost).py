...
class Layout:
    ...
    def __init__(self, ingredients):
        ...
        def step_3():
            frame_meats_section = tk.Frame(frame_header, bg="#FDFDFB")
        ...
        def step_2():
            frame_vege_section = tk.Frame(frame_header, bg="#FDFDFB")
        ...
        #drop down section 1
        def step_1():
            frame_mains_section = tk.Frame(frame_header, bg="#FDFDFB")
