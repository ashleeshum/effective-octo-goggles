...
class Layout:
    ...
    def __init__(self, ingredients):
        ...
        def step_4(self):
            ...
            frame_sauces_section = tk.Frame(frame_header, bg="#FDFDFB")
        ...
        def step_3(self):
            ...
            self.frame_meats_section = tk.Frame(frame_header, bg="#FDFDFB")
        ...
        def step_2(self):
            ...
            self.frame_vege_section = tk.Frame(frame_header, bg="#FDFDFB")
            ...
            next_button_step2 = tk.Button(
                    ...
                    height=1,
                    font=("Lucinds, 10"),
                    command = lambda : [step_3(self)]
                )
            next_button_step2.grid(row=1, column=3, columnspan=4, sticky="e", pady=10, padx=10)

        #drop down section 1
        def step_1():
            self.frame_mains_section = tk.Frame(frame_header, bg="#FDFDFB")
